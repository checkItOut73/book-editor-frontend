...
jest.mock('@actions/editor/setParagraphHeading', () => ({
    setParagraphHeading: (id, heading) => ({
        type: 'SET_PARAGRAPH_HEADING_MOCK',
        id,
        heading
    })
}));
    ...
    describe('when the input is changed', () => {
        ...
        describe('and when the request button is clicked', () => {
            ...
            describe('and when the fetch is complete', () => {
                ...
                test('the paragraph heading is updated', () => {
                    expect(dispatch).toHaveBeenCalledWith({
                        type: 'SET_PARAGRAPH_HEADING_MOCK',
                        id: 23,
                        heading: 'The path to the end'
